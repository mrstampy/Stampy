 ...
 */
public class SystemNettyClient {
  ...
  public void init() throws Exception {
    ...
    gateway.addMessageListener(new StampyMessageListener() {
      ...
      public void messageReceived(StampyMessage<?> message, HostPort hostPort) throws Exception {
        SystemNettyClient.this.hostPort = hostPort;
   ...
   * @return the gateway
   */
  public ClientNettyMessageGateway getGateway() {
    return gateway;
  }
   ...
   *          the new gateway
   */
  public void setGateway(ClientNettyMessageGateway gateway) {
  ...
  public static void main(String[] args) {
    SystemNettyClient client = new SystemNettyClient();
