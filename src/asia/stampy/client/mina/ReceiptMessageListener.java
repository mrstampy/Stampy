...
/**
 * The listener interface for receiving receiptMessage events.
 * The class that is interested in processing a receiptMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addReceiptMessageListener<code> method. When
 * the receiptMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see ReceiptMessageEvent
 */
public class ReceiptMessageListener implements StampyMinaMessageListener {
	...
	public StompMessageType[] getMessageTypes() {
		return new StompMessageType[] { StompMessageType.RECEIPT };
	}
