...
/**
 * The listener interface for receiving messageMessage events.
 * The class that is interested in processing a messageMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addMessageMessageListener<code> method. When
 * the messageMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see MessageMessageEvent
 */
