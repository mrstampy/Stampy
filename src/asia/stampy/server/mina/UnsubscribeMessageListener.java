...
/**
 * The listener interface for receiving unsubscribeMessage events.
 * The class that is interested in processing a unsubscribeMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addUnsubscribeMessageListener<code> method. When
 * the unsubscribeMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see UnsubscribeMessageEvent
 */
public class UnsubscribeMessageListener implements StampyMinaMessageListener {
