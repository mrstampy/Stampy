...
/**
 * The listener interface for receiving connectMessage events.
 * The class that is interested in processing a connectMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addConnectMessageListener<code> method. When
 * the connectMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see ConnectMessageEvent
 */
public class ConnectMessageListener implements StampyMinaMessageListener {
	...
	public StompMessageType[] getMessageTypes() {
		return new StompMessageType[] { StompMessageType.CONNECT, StompMessageType.STOMP };
	}
