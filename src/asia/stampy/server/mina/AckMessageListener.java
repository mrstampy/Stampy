...
/**
 * The listener interface for receiving ackMessage events.
 * The class that is interested in processing a ackMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addAckMessageListener<code> method. When
 * the ackMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see AckMessageEvent
 */
public class AckMessageListener implements StampyMinaMessageListener {
	...
	public StompMessageType[] getMessageTypes() {
		return new StompMessageType[] { StompMessageType.ACK };
	}
