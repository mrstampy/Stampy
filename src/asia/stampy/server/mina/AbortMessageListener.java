...
/**
 * The listener interface for receiving abortMessage events.
 * The class that is interested in processing a abortMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addAbortMessageListener<code> method. When
 * the abortMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see AbortMessageEvent
 */
public class AbortMessageListener implements StampyMinaMessageListener {
	...
	public StompMessageType[] getMessageTypes() {
		return new StompMessageType[] { StompMessageType.ABORT };
	}
