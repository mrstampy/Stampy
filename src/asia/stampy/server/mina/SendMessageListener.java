...
/**
 * The listener interface for receiving sendMessage events.
 * The class that is interested in processing a sendMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addSendMessageListener<code> method. When
 * the sendMessage event occurs, that object's appropriate
 * method is invoked.
 *
