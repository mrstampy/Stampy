...
/**
 * The listener interface for receiving beginMessage events.
 * The class that is interested in processing a beginMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addBeginMessageListener<code> method. When
 * the beginMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see BeginMessageEvent
 */
public class BeginMessageListener implements StampyMinaMessageListener {
	...
	public StompMessageType[] getMessageTypes() {
		return new StompMessageType[] { StompMessageType.BEGIN };
	}
