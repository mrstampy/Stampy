...
/**
 * The listener interface for receiving commitMessage events.
 * The class that is interested in processing a commitMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addCommitMessageListener<code> method. When
 * the commitMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see CommitMessageEvent
 */
public class CommitMessageListener implements StampyMinaMessageListener {
	...
	public StompMessageType[] getMessageTypes() {
		return new StompMessageType[] { StompMessageType.COMMIT };
	}
