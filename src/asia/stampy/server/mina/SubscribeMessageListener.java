...
/**
 * The listener interface for receiving subscribeMessage events.
 * The class that is interested in processing a subscribeMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addSubscribeMessageListener<code> method. When
 * the subscribeMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see SubscribeMessageEvent
 */
