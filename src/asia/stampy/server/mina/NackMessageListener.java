...
/**
 * The listener interface for receiving nackMessage events.
 * The class that is interested in processing a nackMessage
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addNackMessageListener<code> method. When
 * the nackMessage event occurs, that object's appropriate
 * method is invoked.
 *
 * @see NackMessageEvent
 */
public class NackMessageListener implements StampyMinaMessageListener {
	...
	public StompMessageType[] getMessageTypes() {
		return new StompMessageType[] { StompMessageType.NACK };
	}
